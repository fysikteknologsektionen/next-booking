    ...
    return (
        <Stack gap="3rem">
            ...
            <div>
                ...
                <Text>Kontakta Rustmästaren på <Link href="mailto:dp.rust@ftek.se">dp.rust@ftek.se</Link>.</Text>
            </div>

            <div>
                <Heading as="h2" size="lg" marginBottom="0.5em">Bokningsregler</Heading>
                <Text>Alla arrangemang måste anmälas minst två dagar i förväg. Information om hur du gör detta finner du på sidan om <Link href="https://ftek.se/festanmalan/">Anmälan av arrangemang</Link>.</Text>
